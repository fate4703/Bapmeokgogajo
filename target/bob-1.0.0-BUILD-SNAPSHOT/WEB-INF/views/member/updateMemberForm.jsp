		...
		<form action="" method="post" id="updateForm" name="updateForm">
			<table align="center">
				<tr height="70px">
					...
					<td width="400px"><input type="text" class="input" name="id" value="" style="background:lightgray;" readonly></td>
				</tr>
				<tr height="70px">
					<td>비밀번호 : </td>
				...
				<tr height="70px">
					<td>이름 : </td>
					<td><input type="text" class="input" name="name" value="" style="background:lightgray;" readonly></td>
				</tr>
				<tr height="70px">
					<td>생년월일 : </td>
					<td><input type="text" class="input" name="birthday" value="" style="background:lightgray;" readonly></td>
				</tr>
				<tr height="70px">
					<td>성별 : </td>
					<td>
						<input type="radio" name="gender" value="M" disabled><label>남자</label>
						<input type="radio" name="gender" value="F" disabled><label>여자</label>
					</td>
				</tr>
				<tr height="70px">
					<td>이메일</td>
