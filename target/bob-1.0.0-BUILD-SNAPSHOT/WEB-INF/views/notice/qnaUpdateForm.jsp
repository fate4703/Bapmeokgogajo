...
<body>
	...
	<form action="qInsert.no" method="post" encType="multipart/form-data"> 
		<table id=qnaTable">
				...
				<tr>
					<th>&nbsp작성자&nbsp&nbsp <input type="text" id="text" name="writer"  value="${#}" ></th>
					<th></th>
					<th></th>
				</tr>
				<tr>  
					<th>
						<textarea id="content_text" name="question" value="${#}" style="font-family: 'Gugi;" ></textarea>
					</th>
				</tr>
				<tr>  
					<th>
						<textarea id="content_text" name="answer"  value="${#}"  style="font-family: 'Gugi;" ></textarea>
					</th>
				</tr>
				<tr style="border: none;">
					<td colspan="2" align="center" style="border: none;">
					 <button type="submit" class="btn1"  style="position: absolute;">수정완료</button>
