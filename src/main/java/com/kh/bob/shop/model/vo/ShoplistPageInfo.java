...
public class ShoplistPageInfo {
	...
	public ShoplistPageInfo() {}

	public ShoplistPageInfo(int currentPage, int listCount, int pageLimit, int maxPage, int startPage, int endPage,
			int boardLimit) {
		super();
