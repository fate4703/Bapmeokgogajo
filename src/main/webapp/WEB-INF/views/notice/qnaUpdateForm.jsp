...
<body>
	...
	<form action="qupdate.no" method="post" encType="multipart/form-data">
		<table id="qnaTable">
			<th></th>
			<th></th>
			<th></th>
			<tr>
				<th>&nbsp제목&nbsp&nbsp <input type="text" id="text" name="bTitle" value="${board.bTitle}" style="border: 1px solid lightgray; width: 87%;"></th>
				<th></th>
				<th></th>
			</tr>
			<tr>
				<th>&nbsp작성자&nbsp&nbsp <input type="text" id="text" name="mId" value="${board.mId}"></th>
				<th></th>
				<th></th>
			</tr>
			<tr>
			...
			<tr>
				<th><textarea id="content_text" name="bContents" style="font-family: ' Gugi;">${board.bContents}</textarea></th>
			</tr>
			<tr style="border: none;">
				<td colspan="2" align="center" style="border: none;">
					<button type="submit" class="btn1" style="position: absolute;">작성완료</button>
					<button class="btn2" id="cancelBtn"
